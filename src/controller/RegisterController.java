...
public class RegisterController extends JFrame {
    ...
    if (RegisterUserView.JTextFieldUser.getText().trim().length() == 0) {
                ...
                String regiterUser = RegisterModel.registerUser(RegisterUserView.JTextFieldUser.getText(), RegisterUserView.JTextFieldEmail.getText() , String.valueOf(RegisterUserView.JPasswordFieldPass.getText()).trim(), RegisterUserView.JLabelImagePath.getText());
                if (regiterUser != null) {
